...
# Set Date 
DATE=$(TZ=America/New_York date +"%Y%m%d-%s")
...
#Now Its time for other stuffs like cloning, exporting, etc
 ...
 clone() {
	...
	git clone --depth 1 --no-single-branch https://github.com/"$AUTHOR"/AnyKernel3.git -b main
	msg "|| Cloning libufdt ||"
	git submodule init
